...
class ZeroScann():
    ...
    def banner():
      ...
      |______________________|
              |      |
# ================================== #
# Shell Scanner Backddor             #
# Pakai ini supaya bisa crot di luar #
# Jangan di hamilin ya website orang #
# E3748UAV SAMBIL BERAKPUN BUAT TOOLS#
# Pasti rapih , dan sangatlah work   #
# Author: E3748UAV                   #
# Team: Lul'z sec indo               #
# Team: Kurcaci Cyber Team           #
# Team: Spoon Cyber Scurity          #
# ================================== #
              """
        return info
    print(banner())
